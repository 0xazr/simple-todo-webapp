    ...
    <div class="relative h-full">
        <div class="grid grid-cols-7">
            <div class="col-span-5 flex items-center">
                ...
                <h1 class="text-4xl font-bold text-neutral-50">Tasks</h1>
            </div>
        ...
        <div class="mt-7">
            <div v-for="(task, index) in Task.tasks" :key="index">
                <TaskComponent coll="general-task" :list_id="null" :task="task" v-if="!task.is_done" />
            </div>
            <div v-for="list in Task.lists">
                <div v-for="task in list.tasks">
                    <TaskComponent coll="custom-list" :list_id="list.id" :task="task" v-if="!task.is_done" />
                </div>
            </div>
        ...
        <AddTask coll="general-task" id="all-task"/>
    </div>
